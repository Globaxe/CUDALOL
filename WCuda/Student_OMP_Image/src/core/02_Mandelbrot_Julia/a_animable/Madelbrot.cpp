...
Mandelbrot::Mandelbrot(uint w, uint h, const DomaineMath& domaineMath) :
	Animable_I<uchar4>(w, h, "Mandelbrot_julia",domaineMath), variateurAnimation(Interval<int>(20, 120), 1)
    {
...
void Mandelbrot::processForAutoOMP(uchar4* ptrTabPixels, uint w, uint h, const DomaineMath& domaineMath)
    {
    //passer n pour taille de la variation ?? ici 20-120
